...
<style>
    ...
    .subFullBannerSwiper .swiper-wrapper .swiper-slide {
        padding: 0 1rem;
    }
</style>

<!-- 서브 풀 배너 -->
<div id="subFullBannerSwiperContainer">
    <div class="swiper-container subFullBannerSwiper">
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.result) {
                        ...
                        // 배너 영역 세팅
                        $(".subFullBannerSwiper .swiper-wrapper").html(listBody);

                        /* 서브 배너 스와이프*/
                        subFullBanner.swiper = new Swiper(".subFullBannerSwiper", {
                            slidesPerView: 'auto',
                            initialSlide: 0,
                            centeredSlides: true,
                            loop: true,
