...
class LevelReward extends BaseController
{
    /**
     * 내서재
     *
    ...
    public function index()
    {
        try {
            ...
            // set view data
            $this->aSetData['HTML']['CSS'] = $this->linkCss(getAssetPath("/assets/css/" . $this->sLangDirectory . "/event/levelReward.css"));
