...
class Ottcoupon extends BaseController
{
    /**
     * 제휴사 쿠폰 이벤트
     *
    ...
    public function index()
    {
        try {
            ...
            // set view data
            $this->aSetData['HTML']['CSS'] = $this->linkCss(getAssetPath("/assets/css/" . $this->sLangDirectory . "/event/ottcoupon.css"));
